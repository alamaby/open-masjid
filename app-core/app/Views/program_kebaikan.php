...
<style type="text/tailwindcss">
    .stat-card {
        @apply bg-white dark:bg-[#1a2e25] border border-[#dbe6e1] dark:border-[#1e3a2f] p-8 rounded-2xl shadow-sm hover:shadow-md transition-all;
    }
</style>
...
<section class="py-20 px-6 bg-background-light dark:bg-background-dark/50">
    <div class="max-w-[1200px] mx-auto">
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="flex-1 w-full bg-white dark:bg-[#1a2e25] p-4 rounded-3xl border border-[#dbe6e1] dark:border-[#1e3a2f] shadow-xl">
        ...
        <div class="grid lg:grid-cols-2 gap-16">
            ...
            <div class="flex flex-col gap-8">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Efektivitas pendayagunaan dana Zakat, Infaq, dan Sedekah (ZIS)</p>
                </div>
                <div class="space-y-6">
