    ...
    <div class="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <button class="flex items-center gap-2 px-8 py-4 rounded-xl text-base font-bold border border-[#dbe6e1] dark:border-[#1e3a2f] hover:bg-white dark:hover:bg-gray-800 transition-colors">
...
<!-- CTA Section -->
<section class="py-24 px-6" id="tentang">
