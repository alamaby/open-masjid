...
<title>Tentang Kami - Yayasan Masjid Digital Indonesia</title>
<?= $this->endSection() ?>

<?= $this->section('content') ?>
<!-- Header Section -->
<section class="bg-white border-b border-[#dce4e1] dark:bg-background-dark dark:border-gray-800">
    <div class="max-w-[1000px] mx-auto px-6 py-20 text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            <div class="bg-white dark:bg-background-dark border border-[#dce4e1] dark:border-gray-700 p-6 rounded-2xl text-center shadow-sm">
...
<!-- Mission Section -->
<section class="max-w-[1000px] mx-auto px-6 py-20">
    <div class="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div class="relative group">
            <div class="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gray-100 dark:bg-gray-800 border-4 border-white dark:border-gray-700 shadow-2xl relative">
            ...
            <div class="absolute -bottom-8 -left-8 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl border border-[#dce4e1] dark:border-gray-700 max-w-[260px] z-10">
                ...
                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 leading-relaxed">"Arsitektur teknologi yang kokoh untuk kemaslahatan umat di era modern."</p>
            </div>
...
<section class="bg-primary/5 py-24 px-6 border-y border-primary/10">
    <div class="max-w-[1000px] mx-auto">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-black mb-4 text-[#1a2e25] dark:text-white">Keberlangsungan Platform</h2>
        ...
        <div class="grid md:grid-cols-2 gap-8 items-start">
            <div class="bg-white dark:bg-background-dark p-8 rounded-3xl border border-[#dce4e1] dark:border-gray-700 shadow-sm">
                <div class="flex items-center gap-3 mb-6">
                    <span class="material-symbols-outlined text-primary text-3xl">info</span>
                    <h3 class="text-xl font-bold dark:text-white">Kebijakan Donasi</h3>
                </div>
                ...
                <div class="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-900/50 flex gap-3">
                    <span class="material-symbols-outlined text-amber-600">notification_important</span>
                    <p class="text-xs text-amber-800 dark:text-amber-400 font-medium">Donasi hanya dibuka secara aktif saat dibutuhkan untuk menutupi biaya server &amp; maintenance tahunan.</p>
                </div>
            </div>
            <div class="bg-white dark:bg-background-dark p-8 rounded-3xl border border-primary/20 shadow-xl relative overflow-hidden">
                <div class="absolute top-0 right-0 p-4 opacity-5">
                    <span class="material-symbols-outlined text-8xl">volunteer_activism</span>
                </div>
                <h3 class="text-xl font-bold mb-6 dark:text-white">Salurkan Dukungan</h3>
                <div class="space-y-4">
                    <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-[#dce4e1] dark:border-gray-700">
                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase mb-1">Nomor Rekening Yayasan</p>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 font-medium">Bank Syariah Indonesia (BSI)</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500">a.n Yayasan Masjid Digital Indonesia</p>
                    </div>
                    <a class="flex items-center justify-between p-4 bg-primary text-white rounded-xl font-bold hover:bg-[#1f8e5f] transition-colors group" href="#">
